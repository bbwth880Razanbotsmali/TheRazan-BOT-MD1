...
const smsSaludo = () => { return `!مرحبا! أهلاً وسهلاً بك 😊✨
...
const smsBye = () => { return '*╭┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈⊰*\n┊ @user\n┊ *الجروب نور لقد غادر* 😎\n*╰┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈⊰*'}
const smsSpromote = () => { return '*@user او مايد جاد بقيت مشرف منور*'}
const smsSdemote = () => { return '*@userاسف ملش انت لم تبقا مشرف!*'}
const smsSdesc = () => { return '*كلو يجي خبر عاجل تم تغير وصف القروب:*\n\n@desc'}
const smsSsubject = () => { return '*اسم جديد ل المجموعه لا باس فيه:*\n\n@subject'}
const smsSicon = () => { return '*تم تغير الاسم :*\n\n@subject'}بروفايل جديد!!*'}
const smsSrevoke = () => { return '*خبر الرابط تغير خدو الجديد!!*\n\n*@revoke*'}
const smsConexion = () => { return `\n𓃠 ┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈✦ 🟢 الاتصال ✦┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈ 𓃠\n│\n│★ متاح علئ الوتساب  😺\n│\n𓃠 ┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈✦ ✅ ✦┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈ 𓃠`} 
const smsCargando = () => { return `✨ جارٍ التحميل
`} 
const smsCodigoQR = () => { return `\n✅ امسح رمز QR، سينتهي صلاحيته خلال 45 ثانية ✅`}
const smsConexionOFF = () => { return `\n⚠️ لا يوجد اتصال، قم بحذف المجلد${global.authFile} امسح رمز QR
...
//handler.js
const smsCont1 = () => { return `*🔴 الأمر فشل🔴*`}
...
const smsCont6 = () => { return `*❗ لحلها ارسل #reporte *`}
...
const smsCont17 = () => { return `ممنوع الاتصال 📞`}
const smsCont18 = () => { return `📞 المكالمات

لا يُسمح بها بسبب ما قد يجعلك تُحظر

إذا اتصلت بالخطأ، يرجى التواصل مع الشخص المعني بهذا البوت.
إذا كانت حسابًا رسميًا لـ "رزان"، يرجى التواصل مع الدعم عبر ڪ لمعالجة حالتك رقم المطور +967779151032.\n*${global.ig}*`}
...
const smsInt1 = () => { return `مضاد الحذف`}
const smsInt2 = () => { return `ليه حذفتها شفتها ترا`}
