	...
	let fsizedoc = '1'.repeat(10)    
     ...
     if (buffer) try { (type = await conn.getFile(buffer), buffer = type.data) } catch { buffer = buffer }
          ...
          forwardedNewsletterMessageInfo: {
            newsletterJid: '120363321686441475@newsletter',
            newsletterName: '𝑅𝐴𝑍𝐴𝑁﹝✨✨﹞𝐵𝑂َ𝑇𝑆', 
            serverMessageId: '' }, 
                ...options
                }
                })
...
let canalId = ["120363321686441475@newsletter", "120363321686441475@newsletter", "120363321686441475@newsletter", "120363321686441475@newsletter", "120363321686441475@newsletter"]
let canalNombre = ["𝑅𝐴𝑍𝐴𝑁", "عاشق التحدي", "ديلتا", "قناه البوت", "𝑅𝐴𝑍𝐴𝑁﹝✨﹞𝐵𝑂َ𝑇"]
